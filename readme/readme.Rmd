...
Since query is only for one outcome, use `semi_join()` and don't enclude columns from the *outcome_table*. This way you will avoid adding columns containing unnecessary repetititve rows.
